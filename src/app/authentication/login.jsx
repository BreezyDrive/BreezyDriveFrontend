    ...
    <div className="flex w-full h-screen">
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center p-6">
        <div className="w-96 p-6 bg-white rounded-lg shadow-xl">
          {/* Tiêu đề */}
          <h1 className="text-2xl font-bold text-center text-blue-600 mb-2">Login</h1>
          ...
          <div className="mt-4 text-center">
            ...
            <a href="/forgot-password" className="text-blue-600 hover:underline ml-6">Forgot password?</a>
          </div>
        </div>
      </div>
    </div>
